            ...
            <el-tabs type="border-card">
                    ...
                    <div class="grid-content bg-purple">
                      <el-card shadow="always">
                        <div class="Personal_img">
                          ...
                          <!-- 如果数据库等于男的就是蓝色性别 -->
                          <div
                            class="grid-content bg-purple width_70 text_color"
                            v-if="userMessage.sex == '男'"
                          >
                            <el-link type="primary" :underline="false">
                              <i class="el-icon-male font_size_20"></i>
                            </el-link>
                            {{userMessage.name}}
                          </div>
                          <!-- else 就是红色性别 -->
                      ...
                      <div class="padding_10_10">
                        <el-collapse v-model="activeName" accordion>
                          ...
                          <el-collapse-item name="1">
                            <template slot="title">
                              <i class="el-icon-s-custom font_size_20"></i>
                              <span class="text_color_2">用户信息</span>
                            </template>
                            <div>
                              <!-- 手机号：13395059606 -->
                              <el-link target="_blank" :underline="false">
                                <i class="el-icon-phone-outline font_size_16"></i>
                                <span class="font_size_13">手机号： {{userMessage.phone}}</span>
                              </el-link>
                            </div>
                            <div>
                              <!-- 性别 -->
                              ...
                              >
                                <el-link type="danger" :underline="false">
                                  <i class="el-icon-female font_size_16"></i>
                                </el-link>
                            ...
                            <div>
                              ...
                              <el-link type="warning" target="_blank" :underline="false">
                                <i class="el-icon-coin font_size_16"></i>
                                <span class="font_size_13">
                                  当前用户余额：
                                  <span class="color_ffb800">{{userMessage.money}}</span>
                                </span>
                              </el-link>
                            </div>
                            <div>
                              ...
                              <el-link :underline="false">
                                <i class="el-icon-map-location font_size_16"></i>
                                <span class="font_size_13">个人地址：{{userMessage.add}}</span>
                              </el-link>
                            </div>
                            <div>
                              <!-- 注册时间 -->
                              <el-link :underline="false">
                                <i class="el-icon-watch font_size_16"></i>
                                <span class="font_size_13">注册时间：{{userMessage.register_time}}</span>
                              </el-link>
                            </div>
                            <div>
                              <!-- 当前登录时间 -->
                              <el-link :underline="false">
                                <i class="el-icon-watch-1 font_size_16"></i>
                                <span class="font_size_13">当前登录时间：{{userMessage.last_time}}</span>
                              </el-link>
                            </div>
                          </el-collapse-item>
                          <!-- 充值 -->
                          <el-collapse-item name="2">
                            <template slot="title">
                              <i class="el-icon-platform-eleme font_size_20_409EFF"></i>
                              <span class="text_color_3">饿了么充值</span>
                            </template>
                            <el-form
                              :model="ruleForm"
                              status-icon
                                ...
                                <el-col :span="18" :offset="3">
                                  <div class="grid-content bg-purple">
                                    <el-form-item prop="rechargeMoney">
                                      <el-input
                                        type="text"
                                        placeholder="请输您充值的金额"
                                        v-model="ruleForm.rechargeMoney"
                                        maxlength="10"
                                        show-word-limit
                          ...
                          <el-collapse-item name="3">
                            <template slot="title">
                              <i class="el-icon-s-tools font_size_20"></i>
                              <span class="text_color_2">修改密码</span>
                            </template>
                            <el-form
                              :model="ruleForm"
                              status-icon
                          ...
                          <el-collapse-item name="4">
                            <template slot="title">
                              <i class="el-icon-picture font_size_20"></i>
                              <span class="text_color_2">修改头像</span>
                            </template>
                            <el-row :gutter="20">
                          ...
                          <el-collapse-item name="6">
                            <template slot="title">
                              <i class="el-icon-location font_size_20"></i>
                              <span class="text_color_2">修改地址</span>
                            </template>
                            <!-- 详细地址 -->
                            <el-form
                              :model="ruleForm"
                          ...
                          <el-collapse-item name="7">
                            <template slot="title">
                              <i class="el-icon-edit font_size_20"></i>
                              <span class="text_color_2">修改充值密码</span>
                            </template>
                            <el-form
                              :model="ruleForm"
                              status-icon
                              ...
                              <el-row :gutter="20">
                                <el-col :span="18" :offset="3">
                                  <el-form-item prop="NewRechargePassword">
                                    <el-input
                                      type="password"
                                      placeholder="请输入新的充值密码"
                                      v-model="ruleForm.NewRechargePassword"
                                      autocomplete="off"
                                      show-password
                                      onkeyup="value=value.replace(/[\W]/g,'')"
                                    >
              ...
              <el-tab-pane v-if="this.collection == ''">
                ...
                <div style="height: 595px;">
                  ...
                  <p style="text-align:center;margin-top: 10px;">
                    <el-link type="info" style="font-size: 30px;">暂无收藏</el-link>
                  </p>
                </div>
              </el-tab-pane>
              <!-- 我的收藏 v-else-->
              <el-tab-pane v-else>
                ...
                >
                  <el-collapse-item :name="item.o_id">
                    <template slot="title">
                      <img
                        class="img_20px_m10px"
                        style="border-radius: 50px;"
                        :src="item.head_img"
                        alt
                      />
                      <el-link type="_blank" :underline="false" class="text_color_2">{{item.name}}</el-link>
                    </template>
                    <div>
                        ...
                        <el-card :body-style="{ padding: '10px'}" shadow="hover">
                            ...
                            <div class="text_f">
                              <el-link :underline="false">
                                <el-link type="info" :underline="false">
                                  <i class="el-icon-star-on font_size_16"></i>
                                  <span
                                    class="font_size_13 cursor_pointer"
                                    @click="cancel(item.collection_id,item.vehicle_id)"
                                  >取消收藏</span>
                                </el-link>
                              </el-link>
                            </div>
                          ...
                          <el-col :span="12">
                            <div class="grid-content bg-purple-light">
                              <div class="text_w_o_t font_size_15">{{item.vehicle_name}}</div>
                            </div>
                          </el-col>
                          <el-col :span="12">
                            <div class="grid-content bg-purple-light">
                          ...
                          <el-col :span="12">
                            <div class="grid-content bg-purple-light">
                              <el-link
                                ...
                                :underline="false"
                                class="font_weight"
                              >￥{{item.price}}万</el-link>
                              <el-tag
                                type="danger"
                                class="margin_b_10px cursor_pointer"
                                @click="purchase(item.vehicle_id)"
                              >
                                <i class="el-icon-bank-card font_size_16"></i> 点我立即购买
                              </el-tag>
                            </div>
                          </el-col>
                        </el-card>
              ...
              <el-tab-pane>
                <span slot="label">
                  <i class="el-icon-truck"></i> 我发布的车车
                </span>
                <el-collapse v-model="cerCollection" accordion>
                  <!-- 您发布的车车 v-if-->
                  <div
                    v-if="this.onTheShelf == '' && this.undercarriage == '' && this.atAuction == '' && this.auctioned == '' && this.notReviewed == '' "
                  >
                    <el-collapse-item name="1">
                      <template slot="title">
                      ...
                      <div style="height: 520px;">
                        ...
                        <p style="text-align:center;margin-top: 10px;">
                          <el-link type="info" style="font-size: 30px;">未发布车车</el-link>
                        </p>
                      </div>
                    </el-collapse-item>
                  </div>
                  <div v-else>
                    ...
                    <div v-if="this.onTheShelf == ''">
                      <el-collapse-item name="1">
                        <template slot="title">
                          <el-link type="danger" :underline="false">
                            <i class="el-icon-lollipop font_size_20"></i>
                            <span class="text_color_2">您已上架的车车</span>
                          </el-link>
                        </template>
                        <div style="height: 285px;">
                          ...
                          <p style="text-align:center;margin-top: 10px;">
                            <el-link type="info" style="font-size: 30px;">没有已上架的车车</el-link>
                          </p>
                        </div>
                      </el-collapse-item>
                    </div>
                        ...
                        <div v-for="(release,releaseIndex) in onTheShelf" :key="releaseIndex">
                          <el-col :span="24" class="margin_10px">
                            <el-card :body-style="{ padding: '10px'}" shadow="hover">
                              ...
                              <el-col :span="12">
                                <div class="grid-content bg-purple-light margin_b_10px">
                                  <div class="text_w_o_t font_size_13">{{release.vehicle_name}}</div>
                                  <div class="height_20px">
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{release.vehicle_distance}}公里</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{release.introduce}}</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_ffb800 float_f"
                                    >￥{{release.price}}万</div>
                                  </div>
                                  <el-col :span="24" class="padding-left-0">
                                    <div class="grid-content bg-purple-light margin_b_10px">
                                      <div class="text_w_o_t font_size_11 color_b4b3af">
                                        <i class="el-icon-time font_size_13"></i>
                                        {{release.vehicle_time}}
                                      </div>
                                      <div v-if="release.vehicle_state == '已上架'">
                                        <el-link type="danger" :underline="false">
                                          <div
                                            class="text_w_o_t font_size_11"
                                          >{{release.vehicle_state}}</div>
                                        </el-link>
                                      </div>
                                    </div>
                                  </el-col>
                    ...
                    <div v-if="this.undercarriage == ''">
                      <el-collapse-item name="2">
                        <template slot="title">
                          <el-link type="info" :underline="false">
                            <i class="el-icon-sugar font_size_20"></i>
                            <span class="text_color_2">您已下架的车车</span>
                          </el-link>
                        </template>
                        <div style="height: 285px;">
                          <p style="text-align:center;margin-top: 10px;">
                          ...
                          <p style="text-align:center;margin-top: 10px;">
                            <el-link type="info" style="font-size: 30px;">没有已下架的车车</el-link>
                          </p>
                        </div>
                      </el-collapse-item>
                    </div>
                    ...
                    <div v-else>
                      <el-collapse-item name="2">
                        ...
                        <div
                          v-for="(undercarriage,undercarriageIndex) in undercarriage"
                          :key="undercarriageIndex"
                        >
                          <el-col :span="24" class="margin_10px">
                            <el-card :body-style="{ padding: '10px'}" shadow="hover">
                              <div class="img_text_div">
                              ...
                              <el-col :span="12">
                                <div class="grid-content bg-purple-light margin_b_10px">
                                  <div
                                    class="text_w_o_t font_size_13"
                                  >{{undercarriage.vehicle_name}}</div>
                                  <div class="height_20px">
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{undercarriage.vehicle_distance}}公里</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{undercarriage.introduce}}</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_ffb800 float_f"
                                    >￥{{undercarriage.price}}万</div>
                                  </div>
                                  <el-col :span="24" class="padding-left-0">
                                    <div class="grid-content bg-purple-light margin_b_10px">
                                      <div class="text_w_o_t font_size_11 color_b4b3af">
                                        <i class="el-icon-time font_size_13"></i>
                                        {{undercarriage.vehicle_time}}
                                      </div>
                                      <div v-if="undercarriage.vehicle_state == '已下架'">
                                        <el-link type="info" :underline="false">
                                          <div
                                            class="text_w_o_t font_size_11"
                                          >{{undercarriage.vehicle_state}}</div>
                                        </el-link>
                                      </div>
                                    </div>
                                  </el-col>
                      ...
                      <el-collapse-item name="3">
                        <template slot="title">
                          <el-link type="warning" :underline="false">
                            <i class="el-icon-ice-cream-round font_size_20"></i>
                            <span class="text_color_2">您拍卖中的车车</span>
                          </el-link>
                        </template>
                        <div style="height: 285px;">
                          <p style="text-align:center;margin-top: 10px;">
                          ...
                          <p style="text-align:center;margin-top: 10px;">
                            <el-link type="info" style="font-size: 30px;">没有拍卖中的车车</el-link>
                          </p>
                        </div>
                      </el-collapse-item>
                    </div>
                        ...
                        <div v-for="(atAuction,atAuctionIndex) in atAuction" :key="atAuctionIndex">
                          <el-col :span="24" class="margin_10px">
                            <el-card :body-style="{ padding: '10px'}" shadow="hover">
                              ...
                              <el-col :span="12">
                                <div class="grid-content bg-purple-light margin_b_10px">
                                  <div class="text_w_o_t font_size_13">{{atAuction.vehicle_name}}</div>
                                  <div class="height_20px">
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{atAuction.vehicle_distance}}公里</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{atAuction.introduce}}</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_ffb800 float_f"
                                    >￥{{atAuction.price}}万</div>
                                  </div>
                                  <el-col :span="24" class="padding-left-0">
                                    <div class="grid-content bg-purple-light margin_b_10px">
                                      <div class="text_w_o_t font_size_11 color_b4b3af">
                                        <i class="el-icon-time font_size_13"></i>
                                        {{atAuction.vehicle_time}}
                                      </div>
                                      <div v-if="atAuction.vehicle_state == '拍卖中'">
                                        <el-link type="warning" :underline="false">
                                          <div
                                            class="text_w_o_t font_size_11"
                                          >{{atAuction.vehicle_state}}</div>
                                        </el-link>
                                      </div>
                                    </div>
                                  </el-col>
                      ...
                      <el-collapse-item name="4">
                        <template slot="title">
                          <el-link type="success" :underline="false">
                            <i class="el-icon-ice-drink font_size_20"></i>
                            <span class="text_color_2">您已拍卖的车车</span>
                          </el-link>
                        </template>
                        <div style="height: 285px;">
                          <p style="text-align:center;margin-top: 10px;">
                          ...
                          <p style="text-align:center;margin-top: 10px;">
                            <el-link type="info" style="font-size: 30px;">没有已拍卖的车车</el-link>
                          </p>
                        </div>
                      </el-collapse-item>
                    </div>
                        ...
                        <div v-for="(auctioned,auctionedIndex) in auctioned" :key="auctionedIndex">
                          <el-col :span="24" class="margin_10px">
                            <el-card :body-style="{ padding: '10px'}" shadow="hover">
                              ...
                              <el-col :span="12">
                                <div class="grid-content bg-purple-light margin_b_10px">
                                  <div class="text_w_o_t font_size_13">{{auctioned.vehicle_name}}</div>
                                  <div class="height_20px">
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{auctioned.vehicle_distance}}公里</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{auctioned.introduce}}</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_ffb800 float_f"
                                    >￥{{auctioned.price}}万</div>
                                  </div>
                                  <el-col :span="24" class="padding-left-0">
                                    <div class="grid-content bg-purple-light margin_b_10px">
                                      <div class="text_w_o_t font_size_11 color_b4b3af">
                                        <i class="el-icon-time font_size_13"></i>
                                        {{auctioned.vehicle_time}}
                                      </div>
                                      <div v-if="auctioned.vehicle_state == '已拍卖'">
                                        <el-link type="success" :underline="false">
                                          <div
                                            class="text_w_o_t font_size_11"
                                          >{{auctioned.vehicle_state}}</div>
                                        </el-link>
                                      </div>
                                    </div>
                                  </el-col>
                    ...
                    <div v-if="this.notReviewed == ''">
                      <el-collapse-item name="5">
                        <template slot="title">
                          <el-link type="primary" :underline="false">
                            <i class="el-icon-milk-tea font_size_20"></i>
                            <span class="text_color_2">您未审核的车车</span>
                          </el-link>
                        </template>
                        <div style="height: 285px;">
                          <p style="text-align:center;margin-top: 10px;">
                          ...
                          <p style="text-align:center;margin-top: 10px;">
                            <el-link type="info" style="font-size: 30px;">没有未审核的车车</el-link>
                          </p>
                        </div>
                      </el-collapse-item>
                    </div>
                    ...
                    <div v-else>
                      <el-collapse-item name="5">
                        ...
                        <div
                          v-for="(notReviewed,notReviewedIndex) in notReviewed"
                          :key="notReviewedIndex"
                        >
                          <el-col :span="24" class="margin_10px">
                            <el-card :body-style="{ padding: '10px'}" shadow="hover">
                              <div class="img_text_div">
                              ...
                              <el-col :span="12">
                                <div class="grid-content bg-purple-light margin_b_10px">
                                  <div class="text_w_o_t font_size_13">{{notReviewed.vehicle_name}}</div>
                                  <div class="height_20px">
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{notReviewed.vehicle_distance}}公里</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                    >{{notReviewed.introduce}}</div>
                                    <div
                                      class="text_w_o_t font_size_11 color_ffb800 float_f"
                                    >￥{{notReviewed.price}}万</div>
                                  </div>
                                  <el-col :span="24" class="padding-left-0">
                                    <div class="grid-content bg-purple-light margin_b_10px">
                                      <div class="text_w_o_t font_size_11 color_b4b3af">
                                        <i class="el-icon-time font_size_13"></i>
                                        {{notReviewed.vehicle_time}}
                                      </div>
                                      <div v-if="notReviewed.vehicle_state == '未审核'">
                                        <el-link type="primary" :underline="false">
                                          <div
                                            class="text_w_o_t font_size_11"
                                          >{{notReviewed.vehicle_state}}</div>
                                        </el-link>
                                      </div>
                                    </div>
                                  </el-col>
              ...
              <el-tab-pane>
                <span slot="label">
                  <i class="el-icon-notebook-2"></i> 买卖记录
                </span>
                <el-collapse v-model="cerBusiness" accordion>
                  <!-- 购买车辆 v-if-->
                  <el-collapse-item name="1" v-if="this.peanutOrderAdd == ''">
                    <template slot="title">
                      <img class="img_20px_m10px" src="../../assets/peanutImg/gm.png" alt />
                      <el-link type="_blank" :underline="false" class="text_color_2">购买车辆</el-link>
                    </template>
                    <div style="height: 472px;">
                      ...
                      <p style="text-align:center;margin-top: 10px;">
                        <el-link type="info" style="font-size: 30px;">暂无购买车辆</el-link>
                      </p>
                    </div>
                  </el-collapse-item>
                  <!-- 购买车辆 v-else-->
                    ...
                    <div v-for="(order,orderIndex) in peanutOrderAdd" :key="orderIndex">
                      <el-col :span="24" class="margin_10px">
                        <el-card :body-style="{ padding: '10px'}" shadow="hover">
                          ...
                          <el-col :span="12">
                            <div class="grid-content bg-purple-light margin_b_10px">
                              <div class="text_w_o_t font_size_13">{{order.vehicle_name}}</div>
                              <div class="height_20px">
                                <div
                                  class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                >{{order.order_num}}</div>
                                <div
                                  class="text_w_o_t font_size_11 color_b4b3af float_f"
                                >{{order.introduce}}</div>
                                <div
                                  class="text_w_o_t font_size_11 color_ffb800 float_f"
                                >￥{{order.price}}万</div>
                              ...
                              <el-col :span="24" class="padding-left-0">
                                <div class="grid-content bg-purple-light margin_b_10px">
                                  ...
                                  <div v-if="order.o_state == '待验收'">
                                    <el-link type="primary" :underline="false">
                                      <div class="text_w_o_t font_size_11">{{order.o_state}}</div>
                                    </el-link>
                                    <!-- 订单号,卖家id,买家id,车辆id -->
                                    <el-tag
                                      type="primary"
                                      class="cursor_pointer"
                                      @click="primary(order.order_num,order.sell_id,order.buy_id,order.vehicle_id)"
                                    >点我验收</el-tag>
                                    <!-- 订单号,卖家id,买家id,车辆id -->
                                    <el-tag
                                      type="danger"
                                      class="button_mt10px cursor_pointer"
                                      @click="danger(order.order_num,order.sell_id,order.buy_id,order.vehicle_id)"
                                    >点我退货</el-tag>
                                  </div>
                                  <!-- 退款审核中 -->
                                  ...
                                  <div v-if="order.o_state == '待评价'">
                                    ...
                                    <el-tag
                                      type="success"
                                      class="cursor_pointer"
                                      @click="successClick(order.order_num,order.sell_id,order.buy_id,order.vehicle_id)"
                                    >完成购买</el-tag>
                                    <!-- 订单号,卖家id,买家id,车辆id -->
                                    <el-tag
                                      type="warning"
                                      class="button_mt10px cursor_pointer"
                                      @click="warning(order.order_num,order.sell_id,order.buy_id,order.vehicle_id)"
                                    >点我评价</el-tag>
                                  </div>
                                  <!-- 交易完成 -->
                  ...
                  <el-collapse-item name="2" v-if="this.sellvehicleAdd == ''">
                    <template slot="title">
                      <img class="img_20px_m10px" src="../../assets/peanutImg/mc.png" alt />
                      <el-link type="_blank" :underline="false" class="text_color_2">卖出车辆</el-link>
                    </template>
                    <div style="height: 472px;">
                      <p style="text-align:center;margin-top: 10px;">
                      ...
                      <p style="text-align:center;margin-top: 10px;">
                        <el-link type="info" style="font-size: 30px;">暂无卖出车辆</el-link>
                      </p>
                    </div>
                  </el-collapse-item>
                  <!-- 卖出车辆 v-else-->
                    ...
                    <div v-for="(sellvehicle,sellIndex) in sellvehicleAdd" :key="sellIndex">
                      <el-col :span="24" class="margin_10px">
                        <el-card :body-style="{ padding: '10px'}" shadow="hover">
                          ...
                          <el-col :span="12">
                            <div class="grid-content bg-purple-light margin_b_10px">
                              <div class="text_w_o_t font_size_13">{{sellvehicle.vehicle_name}}</div>
                              <div class="height_20px">
                                <div
                                  class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                >
                                  <el-link
                                    ...
                                    :underline="false"
                                    class="font_size_11"
                                  >买家: {{sellvehicle.name}}</el-link>
                                </div>
                                <div
                                  class="text_w_o_t font_size_11 color_b4b3af float_f margin_right_10px"
                                >{{sellvehicle.introduce}}</div>
                                <div
                                  class="text_w_o_t font_size_11 color_ffb800 float_f"
                                >￥{{sellvehicle.price}}万</div>
                              </div>
                              <el-col :span="24" class="padding-left-0">
                                <div class="grid-content bg-purple-light margin_b_10px">
                                  <div class="text_w_o_t font_size_11 color_b4b3af">
                                    <i class="el-icon-time font_size_13"></i>
                                    {{sellvehicle.transaction_time}}
                                  </div>
                                  <el-link type="success" :underline="false">
                                    <div class="text_w_o_t font_size_11">{{sellvehicle.o_state}}</div>
                                  </el-link>
                                </div>
                              </el-col>
                            </div>
              ...
              <div class="grid-content bg-purple">
                <el-form-item label="请输入充值密码" prop="rechargePassword">
                  <el-input
                    type="password"
                    placeholder="充值密码"
                    v-model="ruleForm.rechargePassword"
                    autocomplete="off"
                    show-password
                    onkeyup="value=value.replace(/[\W]/g,'')"
                  >
              ...
              <div class="grid-content bg-purple">
                <el-form-item prop="LoginAccount">
                  <el-input
                    type="text"
                    placeholder="请输入您的账号"
                    v-model="ruleForm.rechargeLoginAccount"
                    maxlength="11"
                    show-word-limit
                    onkeyup="this.value=this.value.replace(/\D/g,'')"
                  >
            ...
            <el-col :span="18" :offset="3">
              <el-form-item prop="LoginPassword">
                <el-input
                  type="password"
                  placeholder="请输入您的密码"
                  v-model="ruleForm.rechargeLoginPassword"
                  autocomplete="off"
                  show-password
                  onkeyup="value=value.replace(/[\W]/g,'')"
                >
          ...
          <el-row :gutter="20">
            <el-col :span="18" :offset="3">
              <div class="demo-drawer__footer button_mb10px">
                ...
                >{{ rechargeing ? '正在修改充值密碼 ...' : '确 定' }}</el-button>
              </div>
            </el-col>
          </el-row>
        </el-form>
          ...
          <el-row :gutter="20">
            <el-col :span="18" :offset="3">
              ...
              <div class="grid-content bg-purple button_mt10px2">
                <el-form-item prop="evaluateContent">
                  <el-input
                    ...
                    v-model="ruleForm.evaluateContent"
                    maxlength="60"
                    show-word-limit
                    onkeyup="value=value.replace(/[^\w\u4E00-\u9FA5]/g, '')"
                  >
              ...
              <div class="demo-drawer__footer button_mb10px">
                ...
                >{{ evaluateloading ? '正在发布评价 ...' : '确定发布' }}</el-button>
              </div>
            </el-col>
          </el-row>
        </el-form>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        //修改密码的三个内容
        LoginAccount: [{ validator: validateAcco, trigger: "blur" }],
        LoginPassword: [{ validator: validatePass, trigger: "blur" }],
        NewPassword: [{ validator: validateNpas, trigger: "blur" }],
        //充值密码
        rechargePassword: [{ validator: validateRech, trigger: "blur" }],
        //新的充值密码
        NewRechargePassword: [{ validator: validateNew, trigger: "blur" }],
        //登录账号
        rechargeLoginAccount: [{ validator: validaterLA, trigger: "blur" }],
        //登录密码
        rechargeLoginPassword: [{ validator: validaterLP, trigger: "blur" }],
        //充值金额
        rechargeMoney: [{ validator: validaterMoney, trigger: "blur" }],
        //修改地址
        address: [{ validator: validaterAdd, trigger: "blur" }],
        //输入评价内容
        evaluateContent: [{ validator: validaterEva, trigger: "blur" }]
      },
      // -------------聊天--------------------------------------
      inputMsg: '',
      list: [],
  ...
  methods: {
    ...
    onSubmitClick() {
      if (this.ruleForm.rechargePassword == "") {
        ...
        this.ruleForm.rechargePassword.match(rechargePasswordAdd) == null
      ) {
        this.$message({
          message: "充值密码格式不正确",
          type: "warning",
    ...
    rechargeButtonClick() {
      ...
      if (this.ruleForm.NewRechargePassword == "") {
        ...
        this.ruleForm.NewRechargePassword.match(rechargePasswordAdd) == null
      ) {
        this.$message({
          message: "充值密码6~9位!",
          type: "warning",
    ...
    rechargeClick() {
      ...
      if (
        this.ruleForm.rechargeLoginAccount == "" ||
        this.ruleForm.rechargeLoginPassword == ""
      ) {
        this.$message.error({
        ...
        this.ruleForm.rechargeLoginAccount.match(account) == null ||
        this.ruleForm.rechargeLoginPassword.match(password) == null
      ) {
        this.$message({
          message: "所需内容格式错误",
          type: "warning",
    ...
    change() {
      ...
      if (
        ...
        this.ruleForm.LoginAccount.match(account) == null ||
        this.ruleForm.LoginPassword.match(password) == null ||
        this.ruleForm.NewPassword.match(password) == null
      ) {
        this.$message({
          message: "所需内容格式错误",
          type: "warning",
